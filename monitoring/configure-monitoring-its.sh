...
while [ $# != 0 ]; do
    case "$1" in
        (-h|--help) echo "$0 usage: ( -h | --help | --host-cluster-context (e.g., --host-cluster-context core-cluster (default value: kind-kubeflex)) | --space-name (e.g., --space-name its1 (default value: its1)) | --monitoring-ns (e.g., --monitoring-ns ks-monitoring (default value: ks-monitoring)))*"
                    exit;;
